...
' are accessible to your module's controls (that inherity from bb_aj_latestuserboktips_mod_KrypinModuleBase
' 
' </summary>

Public Class bb_aj_latestuserboktips_mod_KrypinSettingsBase
