<%@ Control Language="vb" AutoEventWireup="true" CodeBehind="View.ascx.vb" Inherits="krypin.bb_aj.shopbb_aj_shop_Krypin.View" %>
 ...
 <div id="bb_aj_shop_Mod">      
            ...
            <div class="Grid-cell">
                <div class="bb_aj_gridItem ">
                     <div class="ikonheaderBlock">
                       <img src="/DesktopModules/bb_aj_shop_Krypin/images/Shop-128.png" />
                        <h1>Shop</h1> 
        ...
        <div class="aj_bb_KrypinMainGrid Grid--gutters Grid--2of3 u-textCenter bb_aj_shopAdd">
            <div class="Grid-cell">
                <div class="bb_aj_gridItem ">
                     <div class="ikonheaderBlock">                        
        ...
        <div class="aj_bb_KrypinMainGrid Grid--gutters Grid--2of3 u-textCenter bb_aj_shopSettings">
            <div class="Grid-cell">
                <div class="bb_aj_gridItem ">
                     <div class="ikonheaderBlock">                        
                        <h3>Inställningar</h3>
                ...
                <div class="bb_aj_gridItem content-1of1">   
                    ...
                    <div class="Grid-cell">
                        <div class="Demo content-1of6">
                            ...
                            <!-- Inventarieitems start -->
                                <div class="shopitem-card">
                                    <div class="bookitem-button">                                        
                                        <img class="forsaleorsold" src="/Portals/_default/Skins/bb_DAGOBAH_krypin/images/shop/Check-128.png" />
                                    </div>
                                    <div class="bookitem-image">
                                      <img src="/Portals/_default/Skins/bb_DAGOBAH_krypin/images/shop/kaktus_shop.png">
                                    </div>
                                    <div class="bookitem-info">
                                      ...
                                      <div class="invitmtyp">
                                        ...
                                        <p>Blommlåda</p>
                                        <h6>Beskrivning:</h6>
                                        <p>Blomma till blommlådan i krypin</p>
                                      </div>
                                        <div class="shop_prisblock ">
                                            <h5>PRIS: 1000bm</h5>
                                        </div>
                                    </div>                                    
                                  </div>
                                <!-- Inventarieitems slut-->
                    ...
                    <div class="Grid-cell">
                        <div class="Demo content-1of6">
                            ...
                            <div class="shopitem-card">
                                <div class="bookitem-button">                                        
                                    <img class="forsaleorsold" src="/Portals/_default/Skins/bb_DAGOBAH_krypin/images/shop/Euro-Tag-128.png" />
                                </div>
                                <div class="bookitem-image">
                                    <img src="/Portals/_default/Skins/bb_DAGOBAH_krypin/images/shop/brunt_skin_shop.png">
                                </div>
                                <div class="bookitem-info">
                                    <h5>Kaktus</h5>
                                    <div class="invitmtyp">
                                    ...
                                    <p>Blomma till blommlådan i krypin</p>
                                     ...
                                     <div class="shop_prisblock forsale">
                                        <h5>PRIS: 1000bm</h5>
                                    </div>
                                </div>                                    
                            </div>
                    ...
                    <div class="Grid-cell">
                        <div class="Demo content-1of6">
                            ...
                            <div class="shopitem-card">
                                ...
                                <div class="bookitem-image">
                                    <img src="/Portals/_default/Skins/bb_DAGOBAH_krypin/images/shop/empty_shop.png">
                                </div>
                                <div class="bookitem-info">
                                    <h5>Finns inget att visa</h5>
                                    <div class="invitmtyp">
                                    <img src="/Portals/_default/Skins/bb_DAGOBAH_krypin/images/shop/Shop-128_black.png">
                                    </div>
                                </div>                                    
                            </div>
                            <!-- Inventarieitems slut-->
