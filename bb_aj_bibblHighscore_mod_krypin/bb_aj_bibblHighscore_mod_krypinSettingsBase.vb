...
' are accessible to your module's controls (that inherity from bb_aj_bibblHighscore_mod_krypinModuleBase
' 
' </summary>

Public Class bb_aj_bibblHighscore_mod_krypinSettingsBase
