...
''' 
''' Because the control inherits from bb_aj_Bibblomon_KrypinSettingsBase you have access to any custom properties
''' defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
''' </summary>
''' -----------------------------------------------------------------------------
Public Class Settings
    Inherits bb_aj_Bibblomon_KrypinSettingsBase
